...
CloudBox::Impl::Impl(void) 
    ...
    // [Save javascript function and callback]
    {
        ...
        context_->Global()->Set(v8::String::NewFromOneByte(isolate, (const uint8_t*)name_person), object);
    }
    ...
    // [Constructor without C++ class]
    {
        ...
        context_->Global()->Set(v8::String::NewFromUtf8(isolate, "Element"), constructor_f);
    }
    ...
    // [Constructor with C++ class]
    {
        ...
        v8::Handle<v8::Function> constructor_f = constructor_t->GetFunction();
        context_->Global()->Set(v8::String::NewFromUtf8(isolate, "Resource"), constructor_f);
    }
    ...
    // [Interceptor]
    {
        ...
        context_->Global()->Set(v8::String::NewFromUtf8(isolate, "interceptor"), object);
    }
